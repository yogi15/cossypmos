...
public class childTaskPanel extends JPanel {
	...
	private LimitFilterValues filtersValues;
	...
	public childTaskPanel(String name,Vector searchCriteria,Vector searchColumn,LimitFilterValues filterValues,UserJob job, Vector<UserJobsDetails> jobd,RemoteTask remoteTask,RemoteLimit remoteLimit,Users user) {
		setName(name);
		setSearchCriteria(searchCriteria);
		setRemoteLimit(remoteLimit);
		//setRemoteReference(remoteR)
...
jobdataPanel.setUser(getUser());
	...
	private JTabbedPane getJTabbedPane0() {
		...
		//	jTabbedPane0.setBorder(new LineBorder(Color.LIGHT_GRAY, 1, false));
			ImageIcon icon = new ImageIcon(  this.getClass().getResource("/resources/icon/report_filter.gif"));
...
public void setFilterValues(LimitFilterValues filterValues) {
	// TODO Auto-generated method stub
	this.filtersValues = filterValues;
