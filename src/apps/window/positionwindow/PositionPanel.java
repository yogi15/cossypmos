...
public class PositionPanel extends JPanel {
	...
	private PositionFilterValues filtersValues;
	...
	public PositionPanel(String name,Vector searchCriteria,Vector searchColumn,PositionFilterValues filterValues,UserJob job, Vector<UserJobsDetails> jobd,RemoteTask remoteTask,RemoteTrade remoteTrade,RemoteMO remoteMO, Users user) {
	...
	//	jobdataPanel = new DataPanel();
		...
		initComponents();
		this.name = name;
		filtersValues.setRemoteMO(remoteMO);
	...
	private JLabel getJLabel0() {
		if (jLabel0 == null) {
			...
			public void mouseClicked(MouseEvent event) {
				...
				String where =  filtersValues.createWhere(filters,"Position");
			...
			//	sql = " id > 1";
				...
				data = (Vector<Position>)	remoteMO.getPositionOnWhere(where, null);
	...
	private void initialStart() {
		...
		//sql = " id = 1";
		try {
		data = (Vector<Position>)	remoteMO.getPositionOnWhere(sql, null);
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
...
public void setFilterValues(PositionFilterValues filterValues) {
	// TODO Auto-generated method stub
	this.filtersValues = filterValues;
...
Users user = null;
public void processTask(PositionEventProcessor task) {
	// TODO Auto-generated method stub
	System.out.println(" Name " + name + " "+ task.getClassName());
