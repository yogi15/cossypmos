package apps.window.utilwindow.propertypane.enums;
...
import apps.window.utilwindow.propertypane.FutureContractProperty;
import apps.window.utilwindow.propertypane.FutureContractPropertyEnum;
import apps.window.utilwindow.propertypane.SDIProperty;
import apps.window.utilwindow.propertypane.SDIPropertyEnum;
...
public enum SDIPropertyListEnum {
	...
	SDIPropertyListEnum(List<SDIProperty> propertyList) {
