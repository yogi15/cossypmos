package apps.window.utilwindow.propertypane;
...
List<FutureContractProperty> properties = new ArrayList<FutureContractProperty>();
		...
		properties = FutureContractProductPropertyListEnum.FUTURES_FX_TRADE_ATTRIBUTES
		.getPropertyList(FuturesConstants.FUTURES_FX_TRADE_ATTRIBUTE);
		return properties;
		
	} else {
		
			properties = FutureContractProductPropertyListEnum.FUTURES_FX_TRADE	.getPropertyList(FuturesConstants.FUTURES_FX_TRADE);
