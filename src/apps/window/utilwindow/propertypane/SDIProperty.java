...
import apps.window.utilwindow.propertypane.Editor.*;
...
public class SDIProperty  extends Property {
	...
	static public SDIProperty createLEBox(
			String name, String description,final Collection values,LegalEntity le,final String role) {
		
		CellEditorManager.registerEditor(String.class, new CellEditorFactory() {
		
			public CellEditor create() {
				System.out.println(role);
				return   new  LESelectionCellEditor(role);
