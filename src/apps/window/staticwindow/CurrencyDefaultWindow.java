...
public class CurrencyDefaultWindow extends JPanel {
	...
	private void initComponents() {
		...
		add(getJPanel1(), new Constraints(new Leading(16, 1027, 10, 10), new Leading(7, 499, 10, 10)));
		setSize(1051, 510);
	}
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			...
			jPanel2.add(getJPanel0(), new Constraints(new Bilateral(12, 12, 785), new Leading(12, 365, 12, 12)));
			jPanel2.add(getJPanel3(), new Constraints(new Leading(12, 917, 10, 10), new Leading(383, 50, 12, 12)));
		}
		return jPanel2;
	}
	...
	private JPanel getJPanel0() {
		if (jPanel0 == null) {
			...
			jPanel0.add(getJLabel1(), new Constraints(new Leading(18, 12, 12), new Leading(29, 12, 12)));
			jPanel0.add(getJLabel0(), new Constraints(new Leading(264, 10, 10), new Leading(31, 14, 12, 12)));
			jPanel0.add(getJTextField0(), new Constraints(new Leading(327, 67, 12, 12), new Leading(20, 25, 10, 10)));
			jPanel0.add(getcountryJComboBox0(), new Constraints(new Leading(84, 170, 12, 12), new Leading(17, 28, 12, 12)));
			jPanel0.add(getJLabel2(), new Constraints(new Leading(414, 64, 10, 10), new Leading(27, 18, 12, 12)));
			jPanel0.add(getisoCodeJTextField1(), new Constraints(new Leading(493, 66, 10, 10), new Leading(20, 25, 12, 12)));
			jPanel0.add(getJLabel9(), new Constraints(new Leading(586, 10, 10), new Leading(29, 12, 12)));
			jPanel0.add(getdayCountjComboBox3(), new Constraints(new Leading(655, 170, 10, 10), new Leading(17, 28, 12, 12)));
			jPanel0.add(getJLabel3(), new Constraints(new Leading(15, 12, 12), new Leading(74, 10, 10)));
			jPanel0.add(getspotDaysJTextField2(), new Constraints(new Leading(84, 64, 12, 12), new Leading(65, 25, 10, 10)));
			jPanel0.add(getroundingJTextField3(), new Constraints(new Leading(533, 70, 10, 10), new Leading(67, 23, 10, 10)));
			jPanel0.add(getJLabel4(), new Constraints(new Leading(176, 10, 10), new Leading(74, 10, 10)));
			jPanel0.add(getJLabel5(), new Constraints(new Leading(468, 10, 10), new Leading(74, 10, 10)));
			jPanel0.add(getroundingMethodjComboBox1(), new Constraints(new Leading(291, 161, 10, 10), new Leading(63, 28, 12, 12)));
			jPanel0.add(getJButton0(), new Constraints(new Leading(654, 74, 12, 12), new Leading(63, 12, 12)));
			jPanel0.add(getJLabel6(), new Constraints(new Leading(18, 57, 12, 12), new Leading(117, 12, 12)));
			jPanel0.add(getdecimalJTextField4(), new Constraints(new Leading(87, 64, 12, 12), new Leading(112, 25, 10, 10)));
			jPanel0.add(getJLabel7(), new Constraints(new Leading(176, 102, 10, 10), new Leading(112, 12, 12)));
			jPanel0.add(getrateDecimalJTextField5(), new Constraints(new Leading(296, 64, 12, 12), new Leading(109, 25, 12, 12)));
			jPanel0.add(getJLabel8(), new Constraints(new Leading(376, 97, 10, 10), new Leading(112, 18, 12, 12)));
			jPanel0.add(getrateIndexCodejComboBox2(), new Constraints(new Leading(495, 141, 10, 10), new Leading(109, 28, 12, 12)));
			jPanel0.add(getJLabel10(), new Constraints(new Leading(664, 12, 12), new Leading(113, 12, 12)));
			jPanel0.add(getgroupListjComboBox4(), new Constraints(new Leading(744, 114, 10, 10), new Leading(109, 28, 12, 12)));
			jPanel0.add(getJLabel11(), new Constraints(new Leading(18, 12, 12), new Leading(162, 10, 10)));
			jPanel0.add(getBDC(), new Constraints(new Leading(299, 101, 10, 10), new Leading(150, 28, 12, 12)));
			jPanel0.add(getJLabel17(), new Constraints(new Leading(232, 46, 12, 12), new Leading(162, 12, 12)));
			jPanel0.add(getholidayjComboBox5(), new Constraints(new Leading(87, 127, 12, 12), new Leading(150, 28, 10, 10)));
			jPanel0.add(getJLabel18(), new Constraints(new Leading(428, 10, 10), new Leading(158, 20, 12, 12)));
			jPanel0.add(getperiodAjuValue(), new Constraints(new Leading(551, 120, 10, 10), new Leading(150, 28, 12, 12)));
			jPanel0.add(getnonDeliverablejCheckBox1(), new Constraints(new Leading(12, 133, 12, 12), new Leading(255, 10, 10)));
			jPanel0.add(getJCheckBox4(), new Constraints(new Leading(178, 74, 10, 10), new Leading(245, 30, 10, 10)));
			jPanel0.add(getpreicousjCheckBox0(), new Constraints(new Leading(15, 117, 12, 12), new Leading(203, 30, 10, 10)));
			jPanel0.add(getCcilCheckbox(), new Constraints(new Leading(176, 117, 12, 12), new Leading(200, 30, 10, 10)));
		}
		return jPanel0;
	}
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jPanel1.add(getJTabbedPane0(), new Constraints(new Leading(60, 953, 10, 10), new Leading(5, 476, 12, 12)));
		}
		return jPanel1;
	}
