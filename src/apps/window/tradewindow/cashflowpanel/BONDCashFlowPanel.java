...
public class BONDCashFlowPanel extends  CashFlowPanel {
DefaultTableModel cashFlowsModel = new DefaultTableModel();
	
	public BONDCashFlowPanel() {
        initComponents();
    }
	...
	private void initComponents() {
      ...
      jScrollPane1.setViewportView(jTable1);
		...
		commonUTIL.setBackGroundColor(jScrollPane1);
  ...
  public static void main(String args[]) {
      ...
      try {
          ...
          java.util.logging.Logger.getLogger(CashFlowPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
      ...
      java.awt.EventQueue.invokeLater(new Runnable() {
          ...
          public void run() {
              new BONDCashFlowPanel().setVisible(true);
          }
      });
  }
