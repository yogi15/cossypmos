...
public class REPOTradePanel extends  TradePanel  {
	...
	private JPanel jPanel1;
	 ...
	 Trade trade = null;
	 REPOPanel productWindowpanel = null;
 	...
 	javax.swing.DefaultComboBoxModel currencyCombo = new javax.swing.DefaultComboBoxModel();
	...
	private void initComponents() {
		...
		try {
			currency = (Vector) referenceData.getStartUPData("Currency");
		} catch (RemoteException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		add(getJPanel0(), new Constraints(new Bilateral(8, 10, 1146), new Leading(6, 214, 10, 10)));
		setSize(1164, 230);
...
//	jTextField1.setFormat(java.text.DecimalFormat@674dc);
		...
		if (tprice == null) {
            ...
            public void keyTyped(KeyEvent e) {
                if (e.getKeyChar() == KeyEvent.VK_ENTER) { 
                	...
                	if(trade.getProductType().equalsIgnoreCase("REPO")) {
                		REPOPricing pricing = (REPOPricing) productWindowpanel.getPricer();
	...
	private JComboBox getTcurrency() {
		if (tcurrency == null) {
				...
				tcurrency = new JComboBox(
						convertVectortoSringArray(currency));
	...
	private JLabel getJLabel9() {
		if (jLabel9 == null) {
			jLabel9 = new JLabel();
			jLabel9.setFont(new Font("Arial", Font.BOLD, 13));
			jLabel9.setText("SettleMent Date");
		}
		return jLabel9;
	}
	...
	private JPanel getJPanel0() {
		if (jPanel0 == null) {
			...
			jPanel0.add(getJLabel8(), new Constraints(new Leading(12, 10, 10), new Leading(162, 21, 12, 12)));
			jPanel0.add(getJComboBox0(), new Constraints(new Leading(627, 141, 67, 496), new Leading(112, 27, 12, 12)));
			jPanel0.add(getJTextField2(), new Constraints(new Leading(406, 126, 67, 496), new Leading(63, 27, 12, 12)));
			jPanel0.add(getTcurrency(), new Constraints(new Leading(131, 95, 10, 10), new Leading(156, 27, 12, 12)));
			jPanel0.add(getJLabel9(), new Constraints(new Leading(265, 119, 10, 10), new Leading(159, 21, 12, 12)));
			jPanel0.add(getTradestatus(), new Constraints(new Leading(632, 136, 67, 496), new Leading(153, 27, 12, 12)));
			jPanel0.add(getJLabel11(), new Constraints(new Leading(330, 58, 67, 496), new Leading(66, 21, 12, 12)));
			jPanel0.add(getCaction(), new Constraints(new Leading(628, 140, 67, 496), new Leading(108, 27, 12, 12)));
		}
		return jPanel0;
	}
	...
	//	processActionData(actionstatus,trade.getTradedesc1()); 
        ...
        processActionData(actionstatus,"REPO",trade.getTradedesc1(),tradestatus.getText(),rtradeservices);
		this.trade = trade;
	...
	public void setPanelValue(CommonPanel tradeValue) {
		// TODO Auto-generated method stub
		productWindowpanel = (REPOPanel) tradeValue;
