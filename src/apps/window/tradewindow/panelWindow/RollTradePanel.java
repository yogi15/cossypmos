...
public class RollTradePanel extends JPanel {
    ...
    String col [] = {"TradeID","ProductType","TradeDate","End Date","Buy Curr","AMT","Sell Curr","Amt","Rate","RolloverFrom","RollOverTo"};
  ...
  public void setData(Vector trades) {
	  ...
	  for(int i=0;i<trades.size();i++) {
		  ...
		  if(tdata.getTradedesc1().equalsIgnoreCase("FXSWAP")) {
			  rollV.add(tdata.getSwapPrimaryLeg());
			  rollV.add(tdata.getSwapLeg());
		  } else {
			  rollV.add(tdata);
		  }
