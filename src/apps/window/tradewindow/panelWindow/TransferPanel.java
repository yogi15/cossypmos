...
public class TransferPanel extends BackOfficePanel {
	...
	private JTextField getSettlementAmountTextField() {
		...
		if (settlementAmountTextField == null) {
			...
			settlementAmountTextField.setEditable(false);
		}
	...
	private JPanel getJPanel0() {
		if (jPanel0 == null) {
			...
			jPanel0.add(getJTextField4(), new Constraints(new Leading(302, 137, 10, 10), new Leading(14, 12, 12)));
			jPanel0.add(getJTextField8(), new Constraints(new Leading(302, 137, 12, 12), new Leading(43, 12, 12)));
			jPanel0.add(getJLabel4(), new Constraints(new Leading(221, 65, 12, 12), new Leading(20, 12, 12)));
			jPanel0.add(getJLabel8(), new Constraints(new Leading(221, 73, 10, 10), new Leading(48, 12, 12)));
			jPanel0.add(getJLabel7(), new Constraints(new Leading(224, 56, 12, 12), new Leading(162, 20, 12, 12)));
			jPanel0.add(getJLabel6(), new Constraints(new Leading(224, 56, 12, 12), new Leading(139, 12, 12)));
			jPanel0.add(getJLabel5(), new Constraints(new Leading(224, 52, 12, 12), new Leading(113, 12, 12)));
			jPanel0.add(getJLabel10(), new Constraints(new Leading(221, 55, 12, 12), new Leading(80, 12, 12)));
			jPanel0.add(getJTextField10(), new Constraints(new Leading(302, 137, 12, 12), new Leading(74, 12, 12)));
			jPanel0.add(getJTextField5(), new Constraints(new Leading(302, 306, 12, 12), new Leading(104, 12, 12)));
			jPanel0.add(getJTextField7(), new Constraints(new Leading(302, 137, 12, 12), new Leading(133, 12, 12)));
			jPanel0.add(getJTextField6(), new Constraints(new Leading(302, 137, 12, 12), new Leading(162, 12, 12)));
			jPanel0.add(getJLabel9(), new Constraints(new Leading(490, 48, 10, 10), new Leading(15, 19, 12, 12)));
			jPanel0.add(getJTextField9(), new Constraints(new Leading(547, 137, 10, 10), new Leading(8, 12, 12)));
			jPanel0.add(getAmountLabel(), new Constraints(new Leading(7, 49, 12, 12), new Leading(48, 12, 12)));
			jPanel0.add(getJLabel3(), new Constraints(new Leading(7, 57, 12, 12), new Leading(99, 12, 12)));
			jPanel0.add(getJLabel2(), new Constraints(new Leading(7, 66, 12, 12), new Leading(74, 12, 12)));
			jPanel0.add(getJLabel0(), new Constraints(new Leading(9, 62, 12, 12), new Leading(18, 18, 12, 12)));
			jPanel0.add(getSettlementAmountLabel(), new Constraints(new Leading(4, 77, 12, 12), new Leading(132, 12, 12)));
			jPanel0.add(getJScrollPane1(), new Constraints(new Leading(636, 379, 10, 10), new Leading(125, 72, 12, 12)));
			jPanel0.add(getJLabel18(), new Constraints(new Leading(567, 10, 10), new Leading(170, 27, 12, 12)));
