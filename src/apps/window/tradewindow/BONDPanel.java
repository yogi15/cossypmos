...
public class BONDPanel  extends CommonPanel  {
	...
	private JTable getJTable1() {
		if (jTable1 == null) {
			 String col1[] = {"Bond Details        ", "Value      "};
	...
	private JPanel getJPanel3() {
		if (jPanel3 == null) {
			...
			jPanel3.add(getJScrollPane1(), new Constraints(new Bilateral(6, 6, 744), new Bilateral(6, 9, 10, 233)));
		}
		return jPanel3;
	}
	JPanel jPanel9 = null;
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jPanel1.add(getBuysell(), new Constraints(new Leading(12, 42, 10, 10), new Leading(20, 21, 12, 12)));
			jPanel1.add(getBondproduct(), new Constraints(new Leading(69, 432, 10, 10), new Leading(14, 27, 46, 46)));
			...
			jPanel1.add(getJButton0(), new Constraints(new Leading(510, 10, 10), new Leading(14, 27, 67, 290)));
			jPanel1.add(getJLabel14(), new Constraints(new Leading(580, 10, 10), new Leading(14, 27, 67, 290)));
			jPanel1.add(getNominal(), new Constraints(new Leading(635, 132, 448, 485), new Leading(14, 27, 46, 46)));
			//jPanel1.add(getNominal(), new Constraints(new Leading(577, 50, 448, 485), new Leading(20, 21, 67, 290)));
		}
	...
	private JButton getJButton0() {
		...
		PriceButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//	trade.setYield(new Double(tradevalue.tradeyield.getText()).doubleValue());
			      
			        trade.setTradeAmount(new Double(tradevalue.tradeamount.getText()));
			     //   trade.setNominal(new Double(nominal.getText()).doubleValue());
			        trade.setPrice(new Double(tradevalue.tprice.getText()).doubleValue());
			        trade.setTradeDate(tradevalue.tradeDate.getText());
			        trade.setDelivertyDate(tradevalue.tsettlement.getText());
			     //   trade.setQuantity(new Double(tradevalue.tquantity.getText()).doubleValue());
...
//			jTextField7.setFont(new Font("Dialog", Font.PLAIN, 13));
	...
	private NumericTextField getNominal() {
		if (nominal == null) {
			nominal = new NumericTextField(25,format);
	...
	public void setTableValues(Product product) {
		...
		try {
			...
			if(coupons == null || coupons.isEmpty()) {
				commonUTIL.showAlertMessage("Product "+product.getName() + " not getting matching");
				return;
			}
