...
public class UsersSQL {
	...
	final static private String INSERT_FROM_Users =
		"INSERT into Users(id,user_groups,user_name,password, salt) values(?,?,?,?, ?)";
	...
	final static private String SELECTALL =
		"SELECT id,user_name,user_groups,password FROM Users order by user_groups";
	final static private String SELECT =
		"SELECT id,user_name,user_groups,password  FROM Users where id =? ";
	 static private String SELECTONE =
		"SELECT id,user_name,user_groups,password  FROM Users where id =  " ;
	 static private String SELECTUSERPASSWORD =
			"SELECT id,user_name,user_groups,password  FROM Users where " ;
